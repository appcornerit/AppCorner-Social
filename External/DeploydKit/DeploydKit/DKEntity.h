...
/**
 ...
 @return The initialized entity
 */
- (instancetype)initWithName:(NSString *)entityName NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return `YES` on success, `NO` on error
 */
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL refresh;
...
/**
 Log in a user with facebook SDK
 @param error The error object to be set on error
 @param facebookId The facebookId for login the user
 @param password The accessToken for validating the facebookId
 @return `YES` on success, `NO` on error
 */
