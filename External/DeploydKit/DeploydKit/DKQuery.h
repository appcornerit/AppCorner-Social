 ...
 */
@property (NS_NONATOMIC_IOSONLY, readonly, strong) DKQuery *or;
 ...
 */
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *findAll;
...
/**
 ...
 (IN DEPLOYD 0.6.11v YOU MUST COMMENT ADMIN CHECK "ctx.session.isRoot"ON COLLECTION.JS IN "Collection.prototype.count" method)
 @return The matched entity count
 */
@property (NS_NONATOMIC_IOSONLY, readonly) NSInteger countAll;
