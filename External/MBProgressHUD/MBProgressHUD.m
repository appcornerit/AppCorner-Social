...
@property (MB_STRONG) FFCircularProgressView *indicator;
...
- (void)updateIndicators {
	...
	if (mode == MBProgressHUDModeIndeterminate){
        ...
        self.indicator = [[FFCircularProgressView alloc]initWithFrame:CGRectMake(40, 40, 80, 80)];
        self.indicator.center = self.center;
        [self.indicator startSpinProgressBackgroundLayer];
