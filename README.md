...
**You can use AppCorner on appcorner.it to share your apps with others developers, your apps (available in App Store Italy) are posted anonymously on [appcorner.it](http://www.appcorner.it/it/app-sviluppatori.html).**
